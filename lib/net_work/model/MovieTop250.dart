...
part 'MovieTop250.g.dart';


@JsonSerializable()
class MovieTop250 extends Object {
  ...
  MovieTop250(this.count,this.start,this.total,this.subjects,this.title,);

  factory MovieTop250.fromJson(Map<String, dynamic> srcJson) => _$MovieTop250FromJson(srcJson);

  Map<String, dynamic> toJson() => _$MovieTop250ToJson(this);
